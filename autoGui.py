...
while True:
    ...
    class automate:
                ...
                def doStuff(self):
                    if self.move == 1:
                        ...
                        auto.typewrite('%s__%s' %(fileDate, self.file_discription), interval = .05) #writes file with date, time, and temperature the test was run at
    ...
    while True:
        ...
        if x == '1':
            ...
            step[len(step) - 1].file_discription = input('Enter a file name: ')
    ...
    if rs !=1:        
        ...
        input('Press enter to start profile\n')
